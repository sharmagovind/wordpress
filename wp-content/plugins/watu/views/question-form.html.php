...
&nbsp; <a href="admin.php?page=watu_exams"><?php _e('Back to quizzes', 'watu')?></a></p>
...
<p><?php printf(__('You can use this field to explain the correct answer. This will be shown only at the end of the quiz if you have selected the option to display the correct answers. You can use the %s tag to specify different feedback for correctly or incorrectly answered question. Place the explanation that will be shown for correct answer before the %s tag, and the one that will be shown for wrong answer after the %s tag. Using the split tag will NOT work in "Show the answer of a question immediately after the user have selected an answer." mode.<br> This feedback option is a lot more flexible in <a href="%s" target="_blank">WatuPRO</a>.', 'watu'), '{{{split}}}', '{{{split}}}', '{{{split}}}', 'http://calendarscripts.info/watupro/'); ?></p>
</div>
</div>
</div>
