...
<?php endif; ?>
<?php if(empty($exam->no_ajax)):?><input type="button" name="action" onclick="Watu.submitResult()" id="action-button" value="<?php echo empty($advanced_settings['submit_button_value']) ? __('Submit', 'watu') : $advanced_settings['submit_button_value']; ?>"  />
<?php else:?>
	<input type="submit" name="submit_no_ajax" id="action-button" value="<?php echo empty($advanced_settings['submit_button_value']) ? __('Submit', 'watu') : $advanced_settings['submit_button_value']; ?>" />
<?php endif;?>
