...
<div class="wrap">
	...
	<input type="hidden" name="exam_id" value="<?php echo $exam->ID?>">
		...
		<table class="<?php echo $in_shortcode ? 'watu-table' : 'widefat' ?> wp-list-table">
			<tr><th><a href="<?php echo $target_url?>&ob=tU.user_login&offset=<?php echo $offset?>&dir=<?php echo $odir?>&<?php echo $filters_url;?>"><?php _e('Name & Email', 'watu');?></a></th>
			...
			<?php foreach($takings as $taking):
				...
				<?php if(!empty($taking->email)) echo "<br>".$taking->email;?></td>
